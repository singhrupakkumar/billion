              ...
              <div class="register_inner">
                <nav class="registertabs">
                  <div class="nav nav-tabs nav-justified" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="login-box-tab"  href="{{route('login')}}" role="tab" aria-controls="login-box" aria-selected="false">Login</a>
                    <a class="nav-item nav-link" id="signup-box-tab" href="{{route('register')}}" role="tab" aria-controls="signup-box" aria-selected="true">Register</a>
                  </div>
                </nav>
                <div class="tab-content registertabs_content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="login-box" role="tabpanel" aria-labelledby="login-box-tab">
                  ...
                  <div class="tab-pane fade" id="signup-box" role="tabpanel" aria-labelledby="signup-box-tab">
                    <div class="formbox p-md-5">
                      <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="formlist">
                          <div class="form-group">
                             <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Enter your Mobile Number" required autocomplete="phone">
                          ...
                          <div class="form-group" style="width: 161px;">
                            <button type="button" class="btnveryfy">Verify now</button>
                          </div>
                        </div>
